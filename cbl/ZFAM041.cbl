      ...
      *                                                               *
      * Basic Mode DELETE request for a table that has a Query Mode   *
      * FAxxFD schema.                                                *
      *                                                               *
      * When a schema exists, ZFAM002 will LINK to ZFAM041 to         *
      * determine if there are secondary column indexes defined,      *
      * and if so, delete the old CI records.                         *
      *                                                               *
      ...
      *****************************************************************
       ...
       01  T_RES                  PIC  X(08) VALUE 'ZFAM041 '.
      ...
      * and issues a PUT CONTAINER for zFAM041 to process.            *
      *****************************************************************
