      ...
      *                                                               *
      * Basic Mode POST/INSERT request for a table that has a Query   *
      * Mode FAxxFD schema.                                           *
      *                                                               *
      * When a schema exists, ZFAM002 will LINK to ZFAM011 to         *
      * determine if there are secondary column indexes defined,      *
      * and if so, create the CI records.                             *
      *                                                               *
      ...
      *****************************************************************
       ...
       01  T_RES                  PIC  X(08) VALUE 'ZFAM011 '.
      ...
      *****************************************************************
       ...
       01  50701-MESSAGE.
           02  FILLER             PIC  X(16) VALUE 'POST/WRITE for s'.
           02  FILLER             PIC  X(16) VALUE 'econdary column '.
           02  FILLER             PIC  X(16) VALUE 'index failed.   '.
      ...
      * and issues a PUT CONTAINER for zFAM011 to process.            *
      *****************************************************************
      ...
      *****************************************************************
           ...
           PERFORM 2000-GET-NEW-RECORD     THRU 2000-EXIT.
      ...
      *****************************************************************
      * Parse FAxxFD entry.  Write a record to the secondary column   *
      * index file (FAxxCI##) when an index greater than 1 is found.  *
      *****************************************************************
       3100-PARSE-FAXXFD.
           IF  FD-INDEX GREATER THAN ONE
               PERFORM 3200-WRITE-CI       THRU 3200-EXIT.
      ...
      *****************************************************************
       3200-WRITE-CI.
           ...
           IF  ZFAM-DATA(COL:LEN)   EQUAL SPACES
           OR  ZFAM-DATA(COL:LEN)   EQUAL LOW-VALUES
               NEXT SENTENCE
           ELSE
               EXEC CICS WRITE
                    FILE  (CI-FCT)
